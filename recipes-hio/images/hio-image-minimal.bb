...
IMAGE_INSTALL_append =" wpa-supplicant wireless-tools nano alsa-lib  alsa-tools alsa-utils-alsaconf curl fio iperf openssh-sftp-server hio-version hio-wifi hio-bass  hio-rc-local hio-image  dhcp-client \
"
